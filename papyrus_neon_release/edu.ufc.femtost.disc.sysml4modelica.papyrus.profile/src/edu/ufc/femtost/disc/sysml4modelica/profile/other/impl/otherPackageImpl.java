...
public class otherPackageImpl extends EPackageImpl implements otherPackage {
	 ...
	 * @generated
	 */
	public EAttribute getModelicaSimulation_StartTime() {
		return (EAttribute)modelicaSimulationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getModelicaSimulation_StopTime() {
		return (EAttribute)modelicaSimulationEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getModelicaSimulation_Model() {
		return (EReference)modelicaSimulationEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(modelicaSimulationEClass, MODELICA_SIMULATION__START_TIME);
		createEAttribute(modelicaSimulationEClass, MODELICA_SIMULATION__STOP_TIME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getModelicaSimulation_StartTime(), theTypesPackage.getReal(), "startTime", "0.0", 1, 1, ModelicaSimulation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getModelicaSimulation_StopTime(), theTypesPackage.getReal(), "stopTime", "1.0", 1, 1, ModelicaSimulation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
