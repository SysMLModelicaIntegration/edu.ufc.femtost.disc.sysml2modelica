 ...
 * <ul>
 *   <li>{@link edu.ufc.femtost.disc.sysml4modelica.profile.classes.impl.ModelicaClassImpl#getBase_Block <em>Base Block</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelicaClassImpl extends ModelicaClassDefinitionImpl implements ModelicaClass {
		...
		if (base_Block != null && base_Block.eIsProxy()) {
			...
			if (base_Block != oldBase_Block) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, classesPackage.MODELICA_CLASS__BASE_BLOCK, oldBase_Block, base_Block));
			}
		}
		return base_Block;
	}
	...
	public void setBase_Block(Block newBase_Block) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, classesPackage.MODELICA_CLASS__BASE_BLOCK, oldBase_Block, base_Block));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case classesPackage.MODELICA_CLASS__BASE_BLOCK:
