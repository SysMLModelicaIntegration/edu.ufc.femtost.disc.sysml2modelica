...
public class componentsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case componentsPackage.MODELICA_VALUE_PROPERTY: {
