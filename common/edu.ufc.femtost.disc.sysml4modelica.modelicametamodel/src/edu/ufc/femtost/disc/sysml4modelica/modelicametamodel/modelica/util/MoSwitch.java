 ...
 * <!-- end-user-doc -->
 * @see edu.ufc.femtost.disc.sysml4modelica.modelicametamodel.modelica.MoPackage
 * @generated
 */
public class MoSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static MoPackage modelPackage;
	...
	public MoSwitch() {
		if (modelPackage == null) {
			modelPackage = MoPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MoPackage.MODELICA_CLASS_DEFINITION: {
			...
			case MoPackage.ANNOTATION: {
				Annotation annotation = (Annotation)theEObject;
				T result = caseAnnotation(annotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MoPackage.COMMENT: {
