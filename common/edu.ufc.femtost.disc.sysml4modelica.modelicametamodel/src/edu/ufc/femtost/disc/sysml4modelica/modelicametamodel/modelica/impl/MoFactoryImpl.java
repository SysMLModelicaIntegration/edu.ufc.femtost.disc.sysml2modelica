 ...
 * @generated
 */
public class MoFactoryImpl extends EFactoryImpl implements MoFactory {
	/**
	 ...
	 * @generated
	 */
	public static MoFactory init() {
		try {
			MoFactory theMoFactory = (MoFactory)EPackage.Registry.INSTANCE.getEFactory(MoPackage.eNS_URI);
			if (theMoFactory != null) {
				return theMoFactory;
			}
		}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MoPackage.CLASS: return createClass();
			case MoPackage.CONNECTOR: return createConnector();
			case MoPackage.MODEL: return createModel();
			case MoPackage.RECORD: return createRecord();
			case MoPackage.BLOCK: return createBlock();
			case MoPackage.PACKAGE: return createPackage();
			case MoPackage.FUNCTION: return createFunction();
			case MoPackage.DER_FUNCTION: return createDerFunction();
			case MoPackage.EXTENDS_CLAUSE: return createExtendsClause();
			case MoPackage.MODELICA_MODEL: return createModelicaModel();
			case MoPackage.MODELICA_VALUE_PROPERTY: return createModelicaValueProperty();
			case MoPackage.MODELICA_PART: return createModelicaPart();
			case MoPackage.MODELICA_PORT: return createModelicaPort();
			case MoPackage.EQUATION: return createEquation();
			case MoPackage.CONNECT: return createConnect();
			case MoPackage.EQUATION_SECTION: return createEquationSection();
			case MoPackage.MODELICA_FUNCTION_PARAMETER: return createModelicaFunctionParameter();
			case MoPackage.ALGORITHM_SECTION: return createAlgorithmSection();
			case MoPackage.CONSTRAINED_BY_CLAUSE: return createConstrainedByClause();
			case MoPackage.ANNOTATION: return createAnnotation();
			case MoPackage.COMMENT: return createComment();
			case MoPackage.TYPE: return createType();
			default:
	 ...
	 * @generated
	 */
	public MoPackage getMoPackage() {
		return (MoPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static MoPackage getPackage() {
		return MoPackage.eINSTANCE;
	}
