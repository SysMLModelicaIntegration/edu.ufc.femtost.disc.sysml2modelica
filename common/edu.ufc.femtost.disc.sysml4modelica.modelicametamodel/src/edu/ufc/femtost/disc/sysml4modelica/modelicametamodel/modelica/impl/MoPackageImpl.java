 ...
 * @generated
 */
public class MoPackageImpl extends EPackageImpl implements MoPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see edu.ufc.femtost.disc.sysml4modelica.modelicametamodel.modelica.MoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MoPackageImpl() {
		super(eNS_URI, MoFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link MoPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MoPackage init() {
		if (isInited) return (MoPackage)EPackage.Registry.INSTANCE.getEPackage(MoPackage.eNS_URI);

		// Obtain or create and register package
		MoPackageImpl theMoPackage = (MoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MoPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theMoPackage.createPackageContents();

		// Initialize created meta-data
		theMoPackage.initializePackageContents();
		...
		EPackage.Registry.INSTANCE.put(MoPackage.eNS_URI, theMoPackage);
		return theMoPackage;
	}
	 ...
	 * @generated
	 */
	public MoFactory getMoFactory() {
		return (MoFactory)getEFactoryInstance();
	}
