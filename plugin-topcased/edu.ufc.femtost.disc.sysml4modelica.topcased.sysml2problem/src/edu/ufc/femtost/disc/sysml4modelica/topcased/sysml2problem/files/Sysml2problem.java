 ...
 *******************************************************************************/
package edu.ufc.femtost.disc.sysml4modelica.topcased.sysml2problem.files;
...
public class Sysml2problem {
	...
	public Sysml2problem() throws IOException {
		...
		InputStream propertiesInputStream = getFileURL("Sysml2problem.properties").openStream();
		properties.load(propertiesInputStream);
		propertiesInputStream.close();
		EPackage.Registry.INSTANCE.put(getMetamodelUri("MMproblem"), edu.ufc.femtost.disc.sysml4modelica.problemmetamodel.problem.problemPackage.eINSTANCE);
		EPackage.Registry.INSTANCE.put(getMetamodelUri("MMsysml"), org.topcased.sysml.SysMLPackage.eINSTANCE);
