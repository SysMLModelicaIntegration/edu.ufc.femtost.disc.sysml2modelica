 ...
 *******************************************************************************/
package edu.ufc.femtost.disc.sysml4modelica.topcased.sysml2modelica.files;
...
public class Omgsysml2modelica {
	...
	public Omgsysml2modelica() throws IOException {
		...
		InputStream propertiesInputStream = getFileURL("Omgsysml2modelica.properties").openStream();
